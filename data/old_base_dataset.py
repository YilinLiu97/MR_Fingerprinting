...
#        print('patch_i_3: ', patch_i_3)
        img_patch = img[patch_i_1:patch_i_1+patchSize, patch_i_2:patch_i_2+patchSize, patch_i_3:patch_i_3+patchSize] 
    ...
    def filter_patch_pos(self, mask, patchSize):
        ...
        while True:
            ...
            patch_i_3 = random.randint(0, 1152 - patchSize)
...
#            A_img = A_img / (t[numpy.newaxis,:,:] ** 0.5) / 36
    ...
    def read_imMRF(self, file):
        return file['imMRF'][0:self.opt.temporal_nc//2]
